  ...
  return (
    <div className="bg-pastel-red min-h-[100vh]">
      <ComingSoon
        page="Speakers"
        subtitle={
          'Our speaker lineup is almost here! Prepare to be inspired by industry leaders, tech innovators, and creative thinkers who will transform your DevFest experience.'
        }
        fullArt={true}
      />
    </div>
